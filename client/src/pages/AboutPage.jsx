              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="md:w-1/2 text-center md:text-left">
                  ...
                  <p className="text-gray-800 text-lg mb-4">
                    KisanBazar was founded with a simple yet powerful mission: to create a direct link between local farmers and consumers. We believe everyone deserves access to fresh, locally grown produce and farmers deserve fair compensation.
                  </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl font-extrabold text-green-700 mb-6">
                Join the KisanBazar Movement
              </h2>
              <p className="text-xl text-gray-700 mb-12">
                Whether you're a farmer looking to reach new customers or a consumer seeking fresh local produce, KisanBazar is your platform for connection and community.
              </p>
